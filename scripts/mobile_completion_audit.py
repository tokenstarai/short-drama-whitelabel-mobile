...
def check_required_files(root: Path) -> Check:
    ...
    required.append("../.github/workflows/mobile-flutter.yml")
...
def check_ci_workflow(root: Path) -> Check:
    workflow = root.parent / ".github" / "workflows" / "mobile-flutter.yml"
    evidence = ["../.github/workflows/mobile-flutter.yml"]
